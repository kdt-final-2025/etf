    ...
    <>
      ...
      <div
        className={cn(
          ...
          isMobile &&
            (isOpen ? 'fixed left-0 top-0 z-40' : 'fixed -left-64 top-0 z-40')
        )}
      >
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-2">
                  ...
                  {themeCategories.map((theme) => (
                    <li key={theme.id}>
                      <Link
                        ...
                        className="block p-2 rounded-md hover:bg-slate-800"
                      >
                        {theme.name}
                      </Link>
                    </li>
            ...
            <li>
              <Link href="/my-etf" className="flex items-center gap-2 p-2 rounded-md hover:bg-slate-800">
                <Star className="h-5 w-5" />
