...
import { aiRecommend } from '@/lib/api/ai'; // Card 컴포넌트 임포트
import type { ApiResponse } from '@/lib/api/ai'; // ApiResponse 타입 임포트
          ...
          <div className="flex justify-center items-start gap-6">
            ...
            {etfs[1] && (
              <div className="border p-3 rounded w-64 bg-white shadow text-center">
                <Link href={`/etf/${recommendationResult.etfs[1].etfId}`}>
                  <div className="font-medium">
                    {etfs[1].etfName} ({recommendation.subRecommendations[0]})
                  </div>
                </Link>
            ...
            <div className="border-2 border-blue-500 p-4 rounded w-72 bg-blue-50 shadow-lg text-center scale-110">
              <Link href={`/etf/${recommendationResult.etfs[0].etfId}`}>
            ...
            {recommendationResult.etfs[2] && (
              <div className="border p-3 rounded w-64 bg-white shadow text-center">
                <Link href={`/etf/${recommendationResult.etfs[2].etfId}`}>
                  <div className="font-medium">
                    {recommendationResult.etfs[2].etfName} (
                    {recommendation.subRecommendations[1]})
                  </div>
                </Link>
                <div className="text-gray-500 text-sm">
